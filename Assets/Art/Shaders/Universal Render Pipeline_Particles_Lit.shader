...
#pragma exclude_renderers d3d11 gles
      #pragma multi_compile _BaseColor
      //#pragma target 4.0
          ...
          if(u_xlatb1.x)
      {
              ...
              u_xlat23 = _ZBufferParams.z * u_xlat1_d.x + _ZBufferParams.w;
              
              u_xlat23 = float(1.0) / u_xlat23;
              
              u_xlat34 = (-_ProjectionParams.y) + _ProjectionParams.z;
              
              u_xlat1_d.x = u_xlat34 * u_xlat1_d.x + _ProjectionParams.y;
              
              u_xlat1_d.x = (u_xlatb12) ? u_xlat23 : u_xlat1_d.x;
              
              u_xlat12.x = in_f.texcoord1.y * unity_MatrixV[1].z;
              
              u_xlat12.x = unity_MatrixV[0].z * in_f.texcoord1.x + u_xlat12.x;
              
              u_xlat12.x = unity_MatrixV[2].z * in_f.texcoord1.z + u_xlat12.x;
              
              u_xlat12.x = u_xlat12.x + unity_MatrixV[3].z;
              
              u_xlat1_d.x = u_xlat1_d.x + (-_SoftParticleFadeParams.x);
              
              u_xlat1_d.x = -abs(u_xlat12.x) + u_xlat1_d.x;
          ...
          u_xlat16_2_d = u_xlat0_d * u_xlat1_d.xxxx;
          
          u_xlat12.x = dot(in_f.texcoord2.xyz, in_f.texcoord2.xyz);
          
          u_xlat12.x = inversesqrt(u_xlat12.x);
          
          u_xlat12.xyz = u_xlat12.xxx * in_f.texcoord2.xyz;
          
          u_xlat3_d.x = dot(in_f.texcoord3.xyz, in_f.texcoord3.xyz);
          
          u_xlat3_d.x = max(u_xlat3_d.x, 1.17549435e-38);
          
          u_xlat3_d.x = inversesqrt(u_xlat3_d.x);
          
          u_xlat14.xyz = u_xlat3_d.xxx * in_f.texcoord3.xyz;
          
          u_xlat16_4.x = (-_Metallic) * 0.959999979 + 0.959999979;
          
          u_xlat16_15 = (-u_xlat16_4.x) + _Smoothness;
          
          u_xlat16_4.xzw = u_xlat16_2_d.xyz * u_xlat16_4.xxx;
          
          u_xlat16_5.xyz = u_xlat0_d.xyz * u_xlat1_d.xxx + float3(-0.0399999991, -0.0399999991, -0.0399999991);
          ...
          u_xlat16_28 = u_xlat16_6.x * 4.0 + 2.0;
          
          u_xlat16_4.xzw = u_xlat16_2_d.www * u_xlat16_4.xzw;
          ...
          if(u_xlatb1.x)
      {
              ...
              u_xlat16_0_d = texture(_MainLightCookieTexture, u_xlat7_d.xy, _GlobalMipBias.x);
              
              u_xlatb7.xy = equal(float4(float4(_MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat, _MainLightCookieTextureFormat)), float4(0.0, 1.0, 0.0, 0.0)).xy;
              
              u_xlat16_39 = (u_xlatb7.y) ? u_xlat16_0_d.w : u_xlat16_0_d.x;
              
              u_xlat16_8_d.xyz = (u_xlatb7.x) ? u_xlat16_0_d.xyz : float3(u_xlat16_39);
              ...
              u_xlat16_8_d.x = float(1.0);
              
              u_xlat16_8_d.y = float(1.0);
              
              u_xlat16_8_d.z = float(1.0);
      
      }
          
          u_xlat16_8_d.xyz = u_xlat16_8_d.xyz * _MainLightColor.xyz;
          
          u_xlat16_39 = dot((-u_xlat14.xyz), u_xlat12.xyz);
          
          u_xlat16_39 = u_xlat16_39 + u_xlat16_39;
          
          u_xlat16_9_d.xyz = u_xlat12.xyz * (-float3(u_xlat16_39)) + (-u_xlat14.xyz);
          
          u_xlat16_39 = dot(u_xlat12.xyz, u_xlat14.xyz);
          ...
          u_xlat16_0_d = textureLod(unity_SpecCube0, u_xlat16_9_d.xyz, u_xlat16_38);
          
          u_xlat16_38 = u_xlat16_0_d.w + -1.0;
          ...
          u_xlat16_9_d.xyz = u_xlat16_0_d.xyz * float3(u_xlat16_38);
          
          u_xlat16_10.xy = u_xlat16_6.xx * u_xlat16_6.xx + float2(-1.0, 1.0);
          
          u_xlat16_38 = float(1.0) / u_xlat16_10.y;
          
          u_xlat16_21.xyz = (-u_xlat16_5.xyz) + float3(u_xlat16_15);
          
          u_xlat16_21.xyz = float3(u_xlat16_39) * u_xlat16_21.xyz + u_xlat16_5.xyz;
          
          u_xlat14.xyz = float3(u_xlat16_38) * u_xlat16_21.xyz;
          
          u_xlat16_9_d.xyz = u_xlat14.xyz * u_xlat16_9_d.xyz;
          
          u_xlat16_9_d.xyz = in_f.texcoord8.xyz * u_xlat16_4.xzw + u_xlat16_9_d.xyz;
          
          u_xlat16_15 = dot(u_xlat12.xyz, _MainLightPosition.xyz);
          
          u_xlat16_15 = clamp(u_xlat16_15, 0.0, 1.0);
          
          u_xlat16_15 = u_xlat16_15 * unity_LightData.z;
          
          u_xlat16_8_d.xyz = float3(u_xlat16_15) * u_xlat16_8_d.xyz;
          
          u_xlat3_d.xyz = in_f.texcoord3.xyz * u_xlat3_d.xxx + _MainLightPosition.xyz;
          
          u_xlat1_d.x = dot(u_xlat3_d.xyz, u_xlat3_d.xyz);
          ...
          u_xlat1_d.x = dot(u_xlat12.xyz, u_xlat3_d.xyz);
          
          u_xlat1_d.x = clamp(u_xlat1_d.x, 0.0, 1.0);
          
          u_xlat12.x = dot(_MainLightPosition.xyz, u_xlat3_d.xyz);
          
          u_xlat12.x = clamp(u_xlat12.x, 0.0, 1.0);
          
          u_xlat1_d.x = u_xlat1_d.x * u_xlat1_d.x;
          
          u_xlat1_d.x = u_xlat1_d.x * u_xlat16_10.x + 1.00001001;
          
          u_xlat16_15 = u_xlat12.x * u_xlat12.x;
          
          u_xlat1_d.x = u_xlat1_d.x * u_xlat1_d.x;
          
          u_xlat12.x = max(u_xlat16_15, 0.100000001);
          
          u_xlat1_d.x = u_xlat12.x * u_xlat1_d.x;
          
          u_xlat1_d.x = u_xlat16_28 * u_xlat1_d.x;
          
          u_xlat1_d.x = u_xlat16_17.x / u_xlat1_d.x;
          
          u_xlat16_15 = u_xlat1_d.x + -6.10351562e-05;
          
          u_xlat16_15 = max(u_xlat16_15, 0.0);
          
          u_xlat16_15 = min(u_xlat16_15, 1000.0);
          
          u_xlat16_4.xyz = u_xlat16_5.xyz * float3(u_xlat16_15) + u_xlat16_4.xzw;
          
          u_xlat16_2_d.xyz = u_xlat16_4.xyz * u_xlat16_8_d.xyz + u_xlat16_9_d.xyz;
          
          u_xlat16_0_d = min(u_xlat16_2_d, float4(65504.0, 65504.0, 65504.0, 65504.0));
