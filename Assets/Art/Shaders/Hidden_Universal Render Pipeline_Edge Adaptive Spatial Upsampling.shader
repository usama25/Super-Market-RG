  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: EASU
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d = float4(u_xlatu0_d);
          
          u_xlat0_d = u_xlat0_d * _FsrEasuConstants0.yxxy + _FsrEasuConstants0.wzzw;
          
          u_xlat1.xy = floor(u_xlat0_d.zw);
          
          u_xlat0_d = u_xlat0_d + (-u_xlat1.yxxy);
          ...
          u_xlat0_d.xy = textureGather(_BlitTexture, u_xlat1.xy).xy;
          ...
          u_xlat16_51.xy = u_xlat1.yx * float2(0.5, 0.5) + u_xlat16_51.xy;
