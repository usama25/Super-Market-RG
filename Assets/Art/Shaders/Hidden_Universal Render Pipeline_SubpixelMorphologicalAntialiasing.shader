  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord1 = _Metrics.xyxy * float4(-1.0, 0.0, 0.0, -1.0) + u_xlat0.xyxy;
          
          out_v.texcoord2 = _Metrics.xyxy * float4(1.0, 0.0, 0.0, 1.0) + u_xlat0.xyxy;
          
          out_v.texcoord3 = _Metrics.xyxy * float4(-2.0, 0.0, 0.0, -2.0) + u_xlat0.xyxy;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = log2(abs(u_xlat16_0.xyz));
          
          u_xlat0_d.xyz = u_xlat0_d.xyz * float3(0.454545468, 0.454545468, 0.454545468);
          
          u_xlat0_d.xyz = exp2(u_xlat0_d.xyz);
          
          u_xlat16_1.xyz = texture(_BlitTexture, in_f.texcoord1.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat16_3.xyz = texture(_BlitTexture, in_f.texcoord1.zw, _GlobalMipBias.x).xyz;
          ...
          if(u_xlatb18)
      {
          ...
          u_xlat16_4.xyz = texture(_BlitTexture, in_f.texcoord2.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat16_5.xyz = texture(_BlitTexture, in_f.texcoord2.zw, _GlobalMipBias.x).xyz;
          ...
          u_xlat16_4.xyz = texture(_BlitTexture, in_f.texcoord3.xy, _GlobalMipBias.x).xyz;
          ...
          u_xlat16_4.xyz = texture(_BlitTexture, in_f.texcoord3.zw, _GlobalMipBias.x).xyz;
    ...
    Pass // ind: 2, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.texcoord1.xy = u_xlat0.xy * _Metrics.zw;
          
          out_v.texcoord.xy = u_xlat0.xy;
          
          u_xlat1 = _Metrics.xxyy * float4(-0.25, 1.25, -0.125, -0.125) + u_xlat0.xxyy;
          
          u_xlat0 = _Metrics.xyxy * float4(-0.125, -0.25, -0.125, 1.25) + u_xlat0.xyxy;
          ...
          out_v.texcoord4 = _Metrics.xxyy * float4(-8.0, 8.0, -8.0, 8.0) + u_xlat1;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xy = texture(_BlitTexture, in_f.texcoord.xy, _GlobalMipBias.x).xy;
                  ...
                  if(!u_xlatb0.x)
      {
                  ...
                  u_xlat16_2.xy = textureLod(_BlitTexture, u_xlat1_d.xy, 0.0).xy;
                  
                  u_xlat1_d.xy = _Metrics.xy * float2(-2.0, -0.0) + u_xlat1_d.xy;
                  
                  u_xlat1_d.z = u_xlat16_2.y;
      
      }
              
              u_xlat16_2.yz = u_xlat1_d.xz;
              
              u_xlat0_d.xz = u_xlat16_2.xz * float2(0.5, -2.0) + float2(0.0078125, 2.03125);
              
              u_xlat16_0.x = textureLod(_SearchTexture, u_xlat0_d.xz, 0.0).w;
              
              u_xlat0_d.x = u_xlat16_0.x * -2.00787401 + 3.25;
              
              u_xlat1_d.x = _Metrics.x * u_xlat0_d.x + u_xlat16_2.y;
              
              u_xlat1_d.y = in_f.texcoord3.y;
              
              u_xlat16_0.x = textureLod(_BlitTexture, u_xlat1_d.xy, 0.0).x;
                  ...
                  if(!u_xlatb12)
      {
                  ...
                  u_xlat16_3.xy = textureLod(_BlitTexture, u_xlat2.xy, 0.0).xy;
              ...
              u_xlat2.xy = u_xlat16_3.xz * float2(0.5, -2.0) + float2(0.5234375, 2.03125);
              
              u_xlat16_12 = textureLod(_SearchTexture, u_xlat2.xy, 0.0).w;
              
              u_xlat12 = u_xlat16_12 * -2.00787401 + 3.25;
              
              u_xlat1_d.z = (-_Metrics.x) * u_xlat12 + u_xlat16_3.y;
              ...
              u_xlat16_0.z = textureLod(_BlitTexture, u_xlat5.xy, 0.0).x;
              
              u_xlat0_d.xz = u_xlat16_0.xz * float2(4.0, 4.0);
              ...
              u_xlat16_0.xz = textureLod(_AreaTexture, u_xlat0_d.xz, 0.0).xy;
              
              out_f.color.xy = u_xlat16_0.xz;
                  ...
                  if(!u_xlatb12)
      {
                  ...
                  u_xlat16_1.xy = textureLod(_BlitTexture, u_xlat0_d.xy, 0.0).yx;
                  
                  u_xlat0_d.xy = _Metrics.xy * float2(-0.0, -2.0) + u_xlat0_d.xy;
                  
                  u_xlat0_d.z = u_xlat16_1.y;
      
      }
              
              u_xlat16_1.yz = u_xlat0_d.yz;
              
              u_xlat0_d.xy = u_xlat16_1.xz * float2(0.5, -2.0) + float2(0.0078125, 2.03125);
              
              u_xlat16_0.x = textureLod(_SearchTexture, u_xlat0_d.xy, 0.0).w;
              
              u_xlat0_d.x = u_xlat16_0.x * -2.00787401 + 3.25;
              
              u_xlat0_d.x = _Metrics.y * u_xlat0_d.x + u_xlat16_1.y;
              
              u_xlat0_d.y = in_f.texcoord2.x;
              
              u_xlat16_1.x = textureLod(_BlitTexture, u_xlat0_d.yx, 0.0).y;
                  ...
                  if(!u_xlatb12)
      {
                  ...
                  u_xlat16_3.xy = textureLod(_BlitTexture, u_xlat2.xy, 0.0).yx;
              ...
              u_xlat16_3.yz = u_xlat2.yz;
              
              u_xlat9.xy = u_xlat16_3.xz * float2(0.5, -2.0) + float2(0.5234375, 2.03125);
              
              u_xlat16_12 = textureLod(_SearchTexture, u_xlat9.xy, 0.0).w;
              
              u_xlat12 = u_xlat16_12 * -2.00787401 + 3.25;
              
              u_xlat0_d.z = (-_Metrics.y) * u_xlat12 + u_xlat16_3.y;
              ...
              u_xlat16_1.y = textureLod(_BlitTexture, u_xlat4.xy, 0.0).y;
              
              u_xlat4.xy = u_xlat16_1.xy * float2(4.0, 4.0);
              ...
              u_xlat16_0.xy = textureLod(_AreaTexture, u_xlat0_d.xy, 0.0).xy;
              
              out_f.color.zw = u_xlat16_0.xy;
    ...
    Pass // ind: 3, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.x = texture(_BlendTexture, in_f.texcoord1.xy, _GlobalMipBias.x).w;
          
          u_xlat16_0.y = texture(_BlendTexture, in_f.texcoord1.zw, _GlobalMipBias.x).y;
          
          u_xlat16_0.zw = texture(_BlendTexture, in_f.texcoord.xy, _GlobalMipBias.x).zx;
          
          u_xlat1.x = dot(u_xlat16_0, float4(1.0, 1.0, 1.0, 1.0));
          ...
          if(u_xlatb1)
      {
              ...
              out_f.color = textureLod(_BlitTexture, in_f.texcoord.xy, 0.0);
              ...
              u_xlat2.xz = int(u_xlatb1) ? u_xlat16_0.xz : float2(0.0, 0.0);
              
              u_xlat2.yw = (int(u_xlatb1)) ? float2(0.0, 0.0) : u_xlat16_0.yw;
              
              u_xlat0_d.x = (u_xlatb1) ? u_xlat16_0.x : u_xlat16_0.y;
              
              u_xlat0_d.y = (u_xlatb1) ? u_xlat16_0.z : u_xlat16_0.w;
              ...
              u_xlat1 = u_xlat0_d.yyyy * u_xlat16_1;
              
              out_f.color = u_xlat0_d.xxxx * u_xlat16_2 + u_xlat1;
