  ...
  SubShader
  {
    ...
    Pass // ind: 15, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.xyz = textureLod(_BlitCubeTexture, u_xlat0_d.xyz, _BlitMipLevel).xyz;
    ...
    Pass // ind: 16, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          out_f.color = float4(dot(u_xlat16_0.xyz, float3(0.212672904, 0.715152204, 0.0721750036)));
    ...
    Pass // ind: 17, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = textureLod(_BlitCubeTexture, u_xlat0_d.xyz, _BlitMipLevel).w;
          
          out_f.color = float4(u_xlat16_0);
    ...
    Pass // ind: 18, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = textureLod(_BlitCubeTexture, u_xlat0_d.xyz, _BlitMipLevel).x;
    ...
    Pass // ind: 19, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0.xyz = textureLod(_BlitTexture, in_f.texcoord.xy, _BlitMipLevel).xyz;
    ...
    Pass // ind: 20, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = textureLod(_BlitTexture, in_f.texcoord.xy, _BlitMipLevel).w;
    ...
    Pass // ind: 21, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = textureLod(_BlitTexture, in_f.texcoord.xy, _BlitMipLevel).x;
    ...
    Pass // ind: 22, name: 
    {
          ...
          if(u_xlatb0.x)
      {
          ...
          u_xlat8.x = -abs(u_xlat0_d.x) + 1.0;
          
          u_xlat1_d.z = -abs(u_xlat0_d.y) + u_xlat8.x;
          
          u_xlat8.x = max((-u_xlat1_d.z), 0.0);
          ...
          u_xlat1_d.xy = u_xlat8.xy + u_xlat0_d.xy;
    ...
    Pass // ind: 24, name: BilinearDebugDraw
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_0 = textureLod(_BlitTexture, in_f.texcoord.xy, _BlitMipLevel);
    ...
    Pass // ind: 25, name: NearestDebugDraw
    {
