  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: LutBuilderLdr
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat0_d.xyz = u_xlat0_d.xyz * u_xlat1.xxz;
      ...
      ;
          ...
          u_xlat16_1.x = texture(_CurveMaster, u_xlat0_d.xw, _GlobalMipBias.x).x;
          
          u_xlat16_4.x = u_xlat16_1.x;
          
          u_xlat16_4.x = clamp(u_xlat16_4.x, 0.0, 1.0);
          
          u_xlat16_1.x = texture(_CurveMaster, u_xlat0_d.yw, _GlobalMipBias.x).x;
          
          u_xlat16_1.y = texture(_CurveMaster, u_xlat0_d.zw, _GlobalMipBias.x).x;
          ...
          u_xlat16_1.x = texture(_CurveRed, u_xlat0_d.xw, _GlobalMipBias.x).x;
          
          out_f.color.x = u_xlat16_1.x;
          
          out_f.color.x = clamp(out_f.color.x, 0.0, 1.0);
          
          u_xlat16_1.x = texture(_CurveGreen, u_xlat0_d.yw, _GlobalMipBias.x).x;
          
          u_xlat16_1.y = texture(_CurveBlue, u_xlat0_d.zw, _GlobalMipBias.x).x;
          
          out_f.color.yz = u_xlat16_1.xy;
