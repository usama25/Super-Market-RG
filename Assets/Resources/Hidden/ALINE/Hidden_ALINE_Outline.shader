  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
              ...
              if(u_xlatb31)
      {
          ...
          u_xlat16_2.xyz = _Color.xyz * float3(0.959999979, 0.959999979, 0.959999979);
          ...
          u_xlat16_32 = u_xlat0_d.x + u_xlat0_d.x;
          
          u_xlat16_32 = u_xlat16_32 * u_xlat0_d.x + -0.5;
          
          u_xlat16_37 = (-u_xlat1_d.x) + 1.0;
          ...
          u_xlat16_37 = u_xlat16_32 * u_xlat16_37 + 1.0;
          
          u_xlat16_9 = -abs(u_xlat30) + 1.0;
          
          u_xlat16_19.x = u_xlat16_9 * u_xlat16_9;
          
          u_xlat16_19.x = u_xlat16_19.x * u_xlat16_19.x;
          
          u_xlat16_9 = u_xlat16_9 * u_xlat16_19.x;
          
          u_xlat16_32 = u_xlat16_32 * u_xlat16_9 + 1.0;
          
          u_xlat16_32 = u_xlat16_32 * u_xlat16_37;
          
          u_xlat10.x = u_xlat1_d.x * u_xlat16_32;
          ...
          u_xlat16_19.xyz = u_xlat10.xxx * _LightColor0.xyz;
          
          u_xlat10.xyz = float3(u_xlat20) * _LightColor0.xyz;
          
          u_xlat16_32 = (-u_xlat0_d.x) + 1.0;
          ...
          u_xlat16_32 = u_xlat16_32 * 0.959999979 + 0.0399999991;
          
          u_xlat0_d.xyz = u_xlat10.xyz * float3(u_xlat16_32);
          
          u_xlat0_d.xyz = u_xlat16_2.xyz * u_xlat16_19.xyz + u_xlat0_d.xyz;
          
          u_xlat16_2.xyz = u_xlat16_7.xyz * float3(0.5, 0.5, 0.5);
          
          u_xlat16_32 = u_xlat16_9 * 2.23517418e-08 + 0.0399999991;
          
          u_xlat0_d.xyz = u_xlat16_2.xyz * float3(u_xlat16_32) + u_xlat0_d.xyz;
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat16_3.xyz = _Color.xyz * float3(0.959999979, 0.959999979, 0.959999979);
    ...
    Pass // ind: 3, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          out_f.color.xyz = _Color.xyz * float3(0.959999979, 0.959999979, 0.959999979);
